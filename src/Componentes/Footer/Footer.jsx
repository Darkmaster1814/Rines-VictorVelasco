/* Componente de footer para el ecommerce */
/* Importación de componentes */
import Botton from "../Botones/Botton";
const Footer = () => {
    return (<div className="container-fluid bg-container">
        <br />
        <a href="https://goo.gl/maps/r9j4XdFvimS1yXwj6" className="text-decoration-none text-secondary"><p className="ms-2 mt-5 text-center">Contacto</p></a>
